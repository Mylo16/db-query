...
**[Vet Clinic DB]** is a relational database consisting of different kind of animals with their description.
...
- [ ] **[Building realtime application with the database]**
...
Feel free to check the [issues page](https://github.com/Mylo16/db-query/issues/).
